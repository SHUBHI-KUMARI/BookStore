    ...
    <footer className="bg-[var(--color-brand-dark-blue)] text-white/90 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4 shadow-sm">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              Your community marketplace for discovering new stories, reselling
              read books, and connecting with fellow book lovers. Sustainable
              reading made easy.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-4">
              Subscribe for special offers, new arrivals, and marketplace
              highlights.
            </p>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
          <p>
            © {new Date().getFullYear()} ReBook Marketplace. All rights
            reserved.
          </p>
