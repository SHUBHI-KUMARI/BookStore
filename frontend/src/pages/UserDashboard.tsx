              ...
              {ORDERS.map((order) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-6 justify-between md:justify-end w-full md:w-auto mt-4 md:mt-0 pt-4 md:pt-0 border-t md:border-t-0 border-gray-100">
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-bold ${order.status === "Delivered" ? "bg-emerald-50 text-emerald-600" : "bg-amber-50 text-amber-600"}`}
                    >
                      {order.status}
                    </span>
                    <Button
        ...
        {activeTab === "listed" && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex justify-between items-center mb-6">
              ...
              <Button size="sm">
                <Edit3 className="w-4 h-4 mr-2" /> List New Book
              </Button>
            </div>
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-[var(--color-brand-brown)] font-medium mt-1">
                      ${listing.price.toFixed(2)} • {listing.views} Views
                    </p>
                  </div>
                  <div className="flex flex-col items-end gap-2">
                    <span
                      className={`px-2.5 py-1 text-[10px] font-bold rounded-md uppercase tracking-wider ${listing.status === "Approved" ? "bg-emerald-50 text-emerald-600" : "bg-gray-100 text-gray-500"}`}
                    >
                      {listing.status}
                    </span>
