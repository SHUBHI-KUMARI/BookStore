...
import { UploadCloud, CheckCircle2, ShieldCheck, Tag, Info } from 'lucide-react';
...
export const Sell = () => {
  ...
  const [formData, setFormData] = useState({
    title: '', author: '', category: '', condition: '', price: '', description: '', contact: ''
  });
    ...
    return (
      <div className="bg-[var(--color-brand-cream)]/30 min-h-[80vh] flex items-center justify-center py-20 px-4">
        <div className="max-w-md w-full bg-white p-10 rounded-3xl shadow-xl border border-black/5 text-center flex flex-col items-center">
          ...
          <h2 className="text-3xl font-serif font-black text-[var(--color-brand-dark-blue)] mb-3">Listing Submited!</h2>
          <p className="text-gray-500 mb-8">
            Your book has been sent for review. Once approved by our team, it will be live on the marketplace.
          </p>
    ...
    <div className="bg-[var(--color-brand-cream)]/30 min-h-screen pb-24">
      ...
      <div className="bg-[var(--color-brand-dark-blue)] pt-16 pb-32 border-b border-black/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-black text-white tracking-tight mb-4">Sell Your Used Books</h1>
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Give your read books a second life. List them on ReBook to connect with thousands of readers and earn cash securely.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 relative z-10">
        <form onSubmit={handleSubmit} className="bg-white p-6 md:p-10 rounded-3xl shadow-2xl border border-black/5">
          ...
          <div className="flex items-center gap-3 mb-10 pb-6 border-b border-gray-100">
             ...
             <div>
               <h2 className="text-2xl font-bold text-[var(--color-brand-dark-blue)]">Book Details</h2>
               <p className="text-sm text-gray-500">Provide accurate information to help buyers find your book.</p>
             </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="flex items-start gap-2 mt-2 text-xs text-gray-500">
                  ...
                  <p>ReBook takes a 5% platform fee from the final sale price.</p>
                </div>
              </div>

              <div>
                <label className="text-sm font-bold text-[var(--color-brand-dark-blue)] mb-1.5 block">Book Cover Image</label>
                <div className="border-2 border-dashed border-gray-200 rounded-xl bg-gray-50 hover:bg-gray-100 hover:border-[var(--color-brand-muted-orange)]/50 transition-colors p-6 flex flex-col items-center justify-center gap-2 cursor-pointer group">
                  ...
                  <span className="text-sm font-medium text-gray-600 group-hover:text-[var(--color-brand-dark-blue)]">Click to upload or drag & drop</span>
            ...
            <div className="flex items-center gap-3 mb-6">
             ...
             <div>
               <h2 className="text-xl font-bold text-[var(--color-brand-dark-blue)]">Logistics</h2>
               <p className="text-sm text-gray-500">How should buyers coordinate with you?</p>
             </div>
            </div>
          ...
          <div className="mt-10 pt-8 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-6">
             <div className="text-sm font-medium text-gray-500 text-center sm:text-left">
               By listing, you agree to our <a href="#" className="text-[var(--color-brand-muted-orange)] hover:underline">Seller Terms</a>.
             </div>
             <Button 
               type="submit" 
               size="lg" 
